...
export default async function Video({ params }: PageProps) {
	...
	const jsonLd = {
        ...
        url: `https://viralsotwe.pages.dev/v/${file.filecode}`,
        ...
        publisher: {
            '@type': 'Organization',
            name: `${SITENAME}`,
            logo: 'https://viralsotwe.pages.dev/favicon.ico'},
            author: {
                '@type': 'Person',
                name: 'admin',
                url: 'https://viralsotwe.pages.dev'
              }
        }
        const jsonLd2 = {
        '@context': 'https://schema.org',
